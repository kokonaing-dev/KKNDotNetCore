...
namespace KKNDotNetCore.ConsoleAppRefitExamples
{
    public class RefitExample
    {
        private readonly IBlogApi _service = RestService.For<IBlogApi>("https://localhost:7182");
        ...
        public async Task RunAsync()
        {
            ...
            //await UpdateAsync(2, "title 1", "author 2", "content 3");
            //await EditAsync(2);
            //await DeleteAsync(2);
        }
